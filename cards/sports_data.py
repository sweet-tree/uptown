...
NFL_TEAMS = {
    ...
    "DAL": TeamData(
        ...
        uptowns_skyline_prompt="Dallas skyline illustrated, Reunion Tower with its distinctive globe top prominently visible, downtown skyscrapers, Texas flag colors in the sky",
